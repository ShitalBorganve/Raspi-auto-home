...
def Scheduleimport():
        ...
        try:
            ...
            os.system('/home/chris/Raspi-auto-home/Scripts/Schedule_today.py');
        except:
            os.system('echo Error: Could not run Schedule Importer script >> /home/chris/Raspi-auto-home/errorlog');
        print;
        # Pause
        x = raw_input("Press Enter to Return to Menu");   
def ScheduleEdit():
    # Edit the master schedule with nano
    os.system('nano /home/chris/Raspi-auto-home/Schedule/schedule');
    # Recreate the days schedule
    Scheduleimport();
def SensorCheck(Currenttime,Temprate):
    try:
        # Open the first sensors data file
        sensorfile = open('/home/chris/Raspi-auto-home/Sensors/1', 'r');
        ...
        os.system('echo Error: Could not get sensor stats >> /home/chris/Raspi-auto-home/errorlog');
...
def Processing(Currenttime,Sensortemp,Sensortype,Temprate):
	...
	schedfile = open('/home/chris/Raspi-auto-home/Schedule/schedule_today', 'r');
